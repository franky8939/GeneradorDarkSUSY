    ...
    for num in MassPhoton:
        ...
        for tc in TcPhoton:
            if not os.path.exists(DirOutput +
                ...
                NameOutput = "darkSUSY_Event_" + str(eventos) + "_Ma_" + str(num) + "_Tc_" + str(tc)
                ...
                command = 'root -l SelectDark3.C\'("' + \
                          ...
                          DirOutput + '/Roots_Mu_min4/Mu4_' + NameOutput + '.roomaint" , "' + \
...
if __name__ == '__main__':
    ...
    if args.tcphoton == None:
        ...
        print(" :: Using Photon Tc : " + str(args.tcphoton))
    ...
    if os.path.exists(args.dirmad):
        ...
        if os.path.exists(os.getcwd() + "/source/MG5_aMC_v2_6_7"):
            ...
            main(args.event, args.mphoton, args.tcphoton, args.filename, os.getcwd() + "/source/MG5_aMC_v2_6_7",
                 args.modo)
        else:
